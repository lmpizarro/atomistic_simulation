...
\begin{frame}{Apartamientos de la estructura FCC}
  \begin{center}
    Modificando el valor de $\sigma^*_2 = 1.00 \rightarrow 0.85 $	
    \begin{figure}
...
\begin{frame}{Sólido amorfo}
  \begin{center}
    Modificando el valor de $\sigma^*_2 = 1.00 \rightarrow 0.80 $	
    \begin{figure}
      \animategraphics[controls,loop,width=0.5\textwidth]{10}{./vid/pic_amorfo}{0001}{200}
    \end{figure}
	\end{center}
\end{frame}

\begin{frame}{Correlación entre pares del sólido amorfo}
 \begin{center}
...
\begin{frame}{$g_{11}(r^*)$ en función de $T^*$}
	\begin{center}
    \includegraphics[width=\textwidth]{g11_vs_T.pdf}
	\end{center}
\end{frame}

\begin{frame}{$g_{tot}(r^*)$ en función de $T^*$}
	\begin{center}
    \includegraphics[width=\textwidth]{gtot_vs_T.pdf}
	\end{center}
\end{frame}
