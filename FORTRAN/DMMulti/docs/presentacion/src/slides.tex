...
\date{{}\\ \vspace{2.5cm} Introdución a la Simulación Computacional\\ Universidad Nacional de San Martín - Centro Atómico Constituyentes \\ Diciembre de 2015}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{document}
...
\begin{frame}{Correlación entre pares con $T^*=0$}
	...
	\begin{center}
	\hspace{-1em}\includegraphics[width=0.45\textwidth]{vecinos_type1.png}
  \includegraphics[width=0.68\textwidth]{t0_g11_g22.pdf}
	\end{center}
\end{frame}
\begin{frame}{Correlación entre pares con $T^*=0$}
	\begin{center}
	\includegraphics[width=0.9\textwidth]{t0_grs.pdf}
	\end{center}
\end{frame}
