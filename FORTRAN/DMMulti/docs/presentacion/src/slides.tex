...
\begin{frame}{Objetivos}
  \begin{itemize}[<+-|alert@+>]
    \item Aplicación del m\'etodo de dinámica molecular a un sistema sólido binario.
    \item Se variaron pocos parámetros y se estudió el comportamiento del distema en la distintas configuraciones.
    \item Análisis de la correlación entre pares. En un sistema binario existen cuatro: $g_{11}(r)$, $g_{12}(r)$, $g_{22}(r)$ y $g_{tot}(r)$.
    \item Estudio de las vibraciones del cristal mediante mediante el análisis de los especros característicos.
  \end{itemize}
\end{frame}
...
\begin{frame}{Sistema debilmente acoplado}
  \begin{columns}
    ...
    \begin{column}{0.60\linewidth}
      \begin{center}
        \begin{figure}
          \animategraphics[controls,loop,width=1\textwidth]{10}{./vid/pic_cambio}{0001}{200}
        \end{figure}
      \end{center}
    \end{column}
  \end{columns}
...
\begin{frame}{Conclusiones}
    \begin{itemize}[<+-|alert@+>]
        ...
        \item Se hizo un estudio de cómo son las vibraciones del sistema.
        \item Queda para un futuro un análisis más detallado del espectro fonónico.
    \end{itemize}
\end{frame}
