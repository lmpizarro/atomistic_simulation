...
\begin{frame}{Objetivos}
  \begin{itemize}[<+-|alert@+>]
    ...
    \item Se variaron pocos parámetros y se estudió el comportamiento del distema en distintas configuraciones.
    \item Análisis de la correlación entre pares. En un sistema binario existen cuatro: $g_{11}(r)$, $g_{12}(r)$, $g_{22}(r)$ y $g_{tot}(r)$.
    \item Estudio de las vibraciones del cristal mediante el análisis de los especros característicos.
  \end{itemize}
\end{frame}
