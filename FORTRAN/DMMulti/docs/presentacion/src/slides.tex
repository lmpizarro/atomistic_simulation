...
\begin{frame}{Análisis vibracional}
	\begin{itemize}
	\item<+-> xxx
	\item<+-> xxx
  \begin{block}<+->{titulo}
...
\begin{frame}{Intensidad promedio de modos de vibración relación de masas $1.2:1$}
 \begin{center}
   \includegraphics[width=0.95\textwidth]{{fft_1-2}.pdf} \\
 \end{center}
\end{frame}
  

\begin{frame}{Intensidad promedio de modos de vibración relación de masas $8.0:1$}
 \begin{center}
   \includegraphics[width=0.95\textwidth]{{fft_8.0}.pdf} \\
 \end{center}
\end{frame}

\begin{frame}{Espectro de modos de vibración: masa $8.0$}
 \begin{center}
   \includegraphics[width=0.95\textwidth]{fft_veloc_fac_1.pdf} \\
 \end{center}
\end{frame}

\begin{frame}{Espectro de modos de vibración: masa $1.0$}
 \begin{center}
   \includegraphics[width=0.95\textwidth]{fft_veloc_ver_1.pdf} \\
 \end{center}
\end{frame}
