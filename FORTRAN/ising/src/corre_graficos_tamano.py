...
# Está armado paara que se le ingresen dos archivos con una misma
# temperatura, uno de una red de 20x20 y otra de 100x100. 
#De lo contrario hay que cambiar labels y títulos.
...
for nombre in archivo:
    ...
    plt.title('Autocorrelaciones para T = 9.0')
    plt.grid(True) 
    # Zona de ajuste
    n_fin = 250
