...
Las Figuras \eqref{fig:Talta}, \eqref{fig:Tmedia},  \eqref{fig:Tbaja},  
...
\begin{subfigure}{.49\textwidth}
	\centering
      \includegraphics[scale=0.4]{{frame5.0}.pdf} \\
      \caption{Temperatura 5.0}\label{fig:frame5.0}
\end{subfigure}
\begin{subfigure}{.49\textwidth}
	\centering
      \includegraphics[scale=0.4]{{frame3.8}.pdf} \\
...
\begin{subfigure}{.49\textwidth}
	\centering
      \includegraphics[scale=0.4]{{frame2.3}.pdf} \\
      \caption{Temperatura 2.3}\label{fig:frame2.3}
\end{subfigure}
\begin{subfigure}{.49\textwidth}
	\centering
      \includegraphics[scale=0.4]{{frame2.0}.pdf} \\
...
\begin{subfigure}{.49\textwidth}
	\centering
      \includegraphics[scale=0.4]{{frame1.3}.pdf} \\
      \caption{Temperatura 1.3}\label{fig:frame1.3}
\end{subfigure}
\begin{subfigure}{.49\textwidth}
	\centering
      \includegraphics[scale=0.4]{{frame0.5}.pdf} \\
